...
public class UserStats {
	...
	public Map<String, Integer> getGameTypeCount() {
		return gameTypeCount;
	}

	public void setGameTypeCount(Map<String, Integer> gameTypeCount) {
		this.gameTypeCount = gameTypeCount;
	}

	public Map<String, Integer> getGameTypeWinCount() {
		return gameTypeWinCount;
	}

	public void setGameTypeWinCount(Map<String, Integer> gameTypeWinCount) {
		this.gameTypeWinCount = gameTypeWinCount;
	}

	public Map<String, Integer> getGameTypeTotalScoreCount() {
		return gameTypeTotalScoreCount;
	}

	public void setGameTypeTotalScoreCount(Map<String, Integer> gameTypeTotalScoreCount) {
		this.gameTypeTotalScoreCount = gameTypeTotalScoreCount;
	}
	...
	private int loadWinCountByGameId(int gameId) {
		int won = 0;
		for (PlayerScore ps : scoreList) {
			if (ps.getGameId() == gameId && ps.isWon()) {
				won++;
            } 
		}
		return won;
